<template>
  <div class="history-list-container">
    <el-tag
      class="history-item cursor-pointer ml-[5px] mr-[5px]"
      @click="handleClickTag(historyItem)"
      :closable="allowClosable(historyItem)"
      @close="handleCloseTag(historyItem)"
      :type="tagType(historyItem)"
