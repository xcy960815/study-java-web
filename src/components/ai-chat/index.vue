    ...
    <div class="flex-1 my-2 conversation-list">
        ...
        <div class="history-conversation group flex flex-col px-4 py-3 hover:bg-slate-100 rounded-lg"
            ...
            <div class="answer flex-1">
                <div class="prose text-sm text-slate-600 leading-relaxed" v-html="item.content">
                </div>
            </div>
        </div>
        <!-- 当前会话 -->
        <div class="current-conversation group flex flex-col px-4 py-3 hover:bg-slate-100 rounded-lg"
            v-if="!!conversation" :key="conversation.messageId">
            <div class="flex justify-between items-center mb-2">
