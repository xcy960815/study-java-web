<template>
  ...
  <el-table border :data="ollamaModelsListInfo.tableData" style="width: 100%">
    ...
    <el-table-column fixed="right" label="操作" width="150">
      <template #default="{ row }">
        ...
        <el-button link type="danger" size="small" @click="handleClickDeleteModel(row)">删除</el-button>
      </template>
    </el-table-column>
  </el-table>
  <!-- 查看正在内存运行的模型 -->
  <el-dialog v-model="psDialogVisible" title="正在内存运行的模型">
    <el-table border :data="psModelsList" style="width: 100%">
